...
stripe.get("/plans", async () => {
  return {
    plans: [
      { id: "free", name: "Free", price: "$0", features: ["3 cards/day", "Public repos", "Email support"] },
      { id: "pro", name: "Pro", price: "$19", features: ["Unlimited cards", "Private repos", "Evidence vault", "Priority support"] },
      { id: "team", name: "Team", price: "$49", features: ["Everything in Pro", "Multiple seats", "Custom CI", "SLA"] },
    ],
  };
});
