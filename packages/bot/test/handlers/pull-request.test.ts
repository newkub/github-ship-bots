...
import { runWithBotEnv } from "../../src/lib/api";
import { createBotEnv } from "../../src/types";
...
describe("pull request handler", () => {
  ...
  const env = createBotEnv({ API_URL: "https://test", API_TOKEN: "token" });
  beforeEach(() => {
    fetchCalls = [];
