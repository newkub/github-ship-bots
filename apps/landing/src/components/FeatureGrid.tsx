  ...
  return (
    <section class="py-24 sm:py-32 bg-zinc-950 relative">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <ScrollReveal selector=".feature-card" stagger={120}>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <For each={features}>
              {(feature, i) => {
                const Icon = feature.icon;
                return (
                  <div class="feature-card relative rounded-2xl bg-zinc-900/60 p-8 border border-zinc-800 hover:border-indigo-500/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5 hover:bg-zinc-900/80 transition duration-300 group">
