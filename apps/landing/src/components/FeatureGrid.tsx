        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <For each={features}>
            {(feature, i) => {
              ...
              return (
                <div class="relative rounded-2xl bg-zinc-900/60 p-8 border border-zinc-800 hover:border-indigo-500/40 hover:bg-zinc-900/80 hover:shadow-xl hover:shadow-indigo-500/5 transition group">
                  ...
                  <div
                    class={`flex h-12 w-12 items-center justify-center rounded-xl mb-5 border ${colorClass(i())} group-hover:scale-110 transition`}
                  >
                    <Icon size={24} />
                  </div>
