      ...
      <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="text-center mb-16">
          ...
          <p class="text-zinc-400 max-w-2xl mx-auto">
            ship-feed is more than a bot. It is a full-stack loop that connects
            GitHub, Cloudflare, web, mobile, and agents.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <For each={parts}>
            {(part) => {
              ...
              return (
                <div class="rounded-2xl bg-zinc-900/60 p-6 border border-zinc-800 hover:border-indigo-500/30 transition group">
                  <div
                    class={`flex h-12 w-12 items-center justify-center rounded-xl mb-4 border ${colors[part.color]}`}
                  >
                    <Icon size={24} />
                  </div>
                  <h3 class="text-lg font-semibold text-white mb-1">{part.title}</h3>
        ...
        <div class="mt-16 flex flex-col lg:flex-row gap-6 items-center">
          <div class="flex-1 rounded-3xl bg-zinc-900/40 border border-zinc-800/60 p-8 sm:p-12">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <For each={["Implement", "Test", "Evidence", "Deploy"]}>
                {(label) => (
                  <div class="rounded-xl bg-zinc-950/50 border border-zinc-800 p-4 text-center">
                    <Zap size={20} class="mx-auto text-indigo-400 mb-2" />
          ...
          <div class="flex-1 rounded-3xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 p-8 sm:p-12">
            <div class="flex items-center gap-4 mb-6">
              <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-500/10 text-purple-400">
                <ShieldCheck size={28} />
              </div>
              <div>
