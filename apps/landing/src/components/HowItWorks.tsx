        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] gap-4 items-stretch">
          <For each={steps}>
            {(step, i) => {
              ...
              return (
                <>
                  <div class="relative rounded-2xl bg-zinc-900/60 p-6 border border-zinc-800 hover:border-indigo-500/40 hover:-translate-y-1 hover:bg-zinc-900/80 hover:shadow-lg hover:shadow-indigo-500/5 transition duration-300 group">
                  ...
                  {!isLast && (
                    <div class="flex items-center justify-center py-2 lg:py-0">
                      <div class="h-8 w-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 lg:rotate-0 rotate-90">
                        <ArrowRight size={18} />
                      </div>
                    </div>
                  )}
