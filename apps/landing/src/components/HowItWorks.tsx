        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] gap-4 items-stretch">
          <For each={steps}>
            {(step, i) => {
              ...
              return (
                <>
                  <div class="relative rounded-2xl bg-zinc-900/60 p-6 border border-zinc-800 hover:border-indigo-500/40 hover:bg-zinc-900/80 transition group">
                    ...
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 mb-4 group-hover:bg-indigo-500/20 transition">
                      <Icon size={24} />
                    </div>
